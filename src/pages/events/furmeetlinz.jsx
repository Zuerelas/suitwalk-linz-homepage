    ...
    return (
        <div className="container-content">
            ...
            <ScrollAnimation>
                ...
                <p className='container'>{getSecondSaturdayOfMonth()}</p>
            </ScrollAnimation>
            <ScrollAnimation>
                <h2>Uhrzeit</h2>
                <p>Der Stammtisch beginnt um 17:00 Uhr.</p>
            ...
            <ScrollAnimation>
                ...
                <a target='_blank' href="https://t.me/+mWeFhe5k8zExMGI8"><p className='container'>Austrofurs OÖ</p></a>
            </ScrollAnimation>
        </div>
    );
}
