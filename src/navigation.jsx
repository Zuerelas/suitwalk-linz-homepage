            ...
            <div className="nav-wrapper">
                ...
                <nav className={`navigation ${mobileMenuOpen ? 'mobile-open' : ''}`}>
                    ...
                    >
                        ...
                        <ul className={`${windowWidth <= responsiveBreakpoint ? (activeMenu === 'info' ? 'mobile-show' : 'mobile-hide') : 'hide'} nav-list`}>
                    ...
                    >
                        ...
                        <ul className={`${windowWidth <= responsiveBreakpoint ? (activeMenu === 'anmeldung' ? 'mobile-show' : 'mobile-hide') : 'hide'} nav-list`}>
                    ...
                    >
                        ...
                        <ul className={`${windowWidth <= responsiveBreakpoint ? (activeMenu === 'events' ? 'mobile-show' : 'mobile-hide') : 'hide'} nav-list`}>
                    ...
                    >
                        ...
                        <ul className={`${windowWidth <= responsiveBreakpoint ? (activeMenu === 'kontakt' ? 'mobile-show' : 'mobile-hide') : 'hide'} nav-list`}>
